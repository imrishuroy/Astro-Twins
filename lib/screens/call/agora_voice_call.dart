...
class AgoraVoiceCall extends StatefulWidget {
...
class _State extends State<AgoraVoiceCall> {
  late final RtcEngine _engine;
  String channelId = config.channelId;
  bool onOtherUserJoined = true;
